...
ESCAPE_SCREEN = pygame.image.load(join("assets","Background","DIGGY_ESCAPED.png"))
wall = pygame.image.load(join("assets","Background","cave wall.png"))
base_diggy = pygame.image.load(join("assets","Characters","Diggy.png"))
...
floor_spike = pygame.image.load(join("assets","Background","F_SPIKE.png"))
DOOR = pygame.image.load(join("assets","Background","Door.png"))
...
def main():
    ...
    ##floor spikes
    floor_spike1 = FloorSpikes(floor_spike, 600, 624, 142, 8, BLACK, 10)
    floor_spike2 = FloorSpikes(floor_spike, 1235, 624, 142, 8, BLACK, 10)
    floor_spike3 = FloorSpikes(floor_spike, 1600, 624, 142, 8, BLACK, 10)
    floor_spike4 = FloorSpikes(floor_spike, 2100, 624, 142, 8, BLACK, 10)
    floor_spike5 = FloorSpikes(floor_spike, 2400, 624, 142, 8, BLACK, 10)
    floor_spike6 = FloorSpikes(floor_spike, 2800, 624, 142, 8, BLACK, 10)
    floor_spike7 = FloorSpikes(floor_spike, 3152, 624, 142, 8, BLACK, 10)
    ...
    while run:
        ...
        if keys[pygame.K_a]:
            ...
            if ((ball.x - ball.radius) <= 260) and ((ball.x - ball.radius) > front_check.x):
                ...
                ##floor spike move right
                move_right(floor_spike1)
                move_right(floor_spike2)
                move_right(floor_spike3)
                move_right(floor_spike4)
                move_right(floor_spike5)
                move_right(floor_spike6)
                move_right(floor_spike7)
        ...
        if keys[pygame.K_d]:
            ...
            if ((ball.x + ball.radius) >= 940) and ((ball.x + ball.radius) < back_check.x):
                ...
                #move left for floor spikes
                move_left(floor_spike1)
                move_left(floor_spike2)
                move_left(floor_spike3)
                move_left(floor_spike4)
                move_left(floor_spike5)
                move_left(floor_spike6)
                move_left(floor_spike7)
        ...
        #all floor spike collision
        floor_spike_collision(floor_spike1, ball, player_health)
        floor_spike_collision(floor_spike2, ball, player_health)
        floor_spike_collision(floor_spike3, ball, player_health)
        floor_spike_collision(floor_spike4, ball, player_health)
        floor_spike_collision(floor_spike5, ball, player_health)
        floor_spike_collision(floor_spike6, ball, player_health)
        floor_spike_collision(floor_spike7, ball, player_health)
        ...
        if player_health.width <= 0:
            ...
            if keys[pygame.K_r]:
                ...
                ##resets for floor spikes
                reset_object(floor_spike1, 600, 624)
                reset_object(floor_spike2, 1235, 624)
                reset_object(floor_spike3, 1600, 624)
                reset_object(floor_spike4, 2100, 624)
                reset_object(floor_spike5, 2400, 624)
                reset_object(floor_spike6, 2800, 624)
                reset_object(floor_spike7, 3152, 624)
